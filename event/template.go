...
`,
	CalendarEventCreated: `# Discourse 日历事件创建 事件通知
**实例地址**: [{{.Header.Instance}}]({{.Header.Instance}})
**事件 ID**: {{.Header.EventId}}
**事件类型**: {{.Header.Event}}
...
`,
	CategoryDestroyed: `# Discourse 分类删除 事件通知
**实例地址**: [{{.Header.Instance}}]({{.Header.Instance}})
**事件 ID**: {{.Header.EventId}}
**事件类型**: {{.Header.Event}}
**分类 ID**: {{.Data.id}}
...
`,
	GroupCreated: `# Discourse 群组创建 事件通知
**实例地址**: [{{.Header.Instance}}]({{.Header.Instance}})
**事件 ID**: {{.Header.EventId}}
**事件类型**: {{.Header.Event}}
**群组 ID**: {{.Data.id}}
...
**是否可以编辑群组**: {{.Data.can_edit_group}}
**是否发布阅读状态**: {{.Data.publish_read_state}}
`,
...
`,
	NotificationCreated3: `# Discourse 通知创建 事件通知
**实例地址**: [{{.Header.Instance}}]({{.Header.Instance}})
**事件 ID**: {{.Header.EventId}}
**事件类型**: {{.Header.Event}}
**通知标题**: {{.Data.fancy_title}}
...
**显示用户**: [{{.Header.Instance}}/u/{{.Data.data.display_username}}]({{.Header.Instance}}/u/{{.Data.data.display_username}})
`,
	NotificationCreated20: `# Discourse 通知创建 事件通知
**实例地址**: [{{.Header.Instance}}]({{.Header.Instance}})
**事件 ID**: {{.Header.EventId}}
**事件类型**: {{.Header.Event}}
**通知标题**: {{.Data.fancy_title}}
...
**话题 ID**: {{.Data.topic_id}}
**话题链接**: [{{.Header.Instance}}/t/{{.Data.slug}}/{{.Data.topic_id}}]({{.Header.Instance}}/t/{{.Data.slug}}/{{.Data.topic_id}})
**帖子链接**: [{{.Header.Instance}}{{.Data.data.post_url}}]({{.Header.Instance}}{{.Data.data.post_url}})
`,
...
`,
	NotificationCreated27: `# Discourse 通知创建 事件通知
**实例地址**: [{{.Header.Instance}}]({{.Header.Instance}})
**事件 ID**: {{.Header.EventId}}
**事件类型**: {{.Header.Event}}
**通知标题**: {{.Data.fancy_title}}
...
**显示用户**: [{{.Header.Instance}}/u/{{.Data.data.display_username}}]({{.Header.Instance}}/u/{{.Data.data.display_username}})
`,
	NotificationCreated28: `# Discourse 通知创建 事件通知
**实例地址**: [{{.Header.Instance}}]({{.Header.Instance}})
**事件 ID**: {{.Header.EventId}}
**事件类型**: {{.Header.Event}}
**通知标题**: {{.Data.fancy_title}}
...
**显示用户**: [{{.Header.Instance}}/u/{{.Data.data.display_username}}]({{.Header.Instance}}/u/{{.Data.data.display_username}})
`,
	NotificationCreated37: `# Discourse 通知创建 事件通知
**实例地址**: [{{.Header.Instance}}]({{.Header.Instance}})
**事件 ID**: {{.Header.EventId}}
**事件类型**: {{.Header.Event}}
**通知 ID**: {{.Data.id}}
...
**创建时间**: {{FormatTime .Data.created_at}}
`,
	NotificationCreated41: `# Discourse 通知创建 事件通知
**实例地址**: [{{.Header.Instance}}]({{.Header.Instance}})
**事件 ID**: {{.Header.EventId}}
**事件类型**: {{.Header.Event}}
**通知 ID**: {{.Data.id}}
...
**标签描述**: {{.Data.description}}
`,
	TagUpdated: `# Discourse 标签更新 事件通知
**实例地址**: [{{.Header.Instance}}]({{.Header.Instance}})
**事件 ID**: {{.Header.EventId}}
**事件类型**: {{.Header.Event}}
**标签 ID**: {{.Data.id}}
...
**标签描述**: {{.Data.description}}
`,
	TopicUnvote: `# Discourse 话题取消投票 事件通知
**实例地址**: [{{.Header.Instance}}]({{.Header.Instance}})
**事件 ID**: {{.Header.EventId}}
**事件类型**: {{.Header.Event}}
**话题 ID**: {{.Data.topic_id}}
...
**回复数量**: {{.Data.reply_count}}
`,
	TopicPinnedGloballyStatusUpdated: `# Discourse 话题全局置顶状态更新 事件通知
**实例地址**: [{{.Header.Instance}}]({{.Header.Instance}})
**事件 ID**: {{.Header.EventId}}
**事件类型**: {{.Header.Event}}
**话题标题**: {{.Data.title}}
...
**话题 ID**: {{.Data.id}}
**置顶状态**: {{.Data.pinned}}
**全局置顶**: {{.Data.pinned_globally}}
**置顶时间**: {{FormatTime .Data.pinned_at}}
**置顶截止时间**: {{FormatTime .Data.pinned_until}}
**创建时间**: {{FormatTime .Data.created_at}}
**最后回复时间**: {{FormatTime .Data.last_posted_at}}
**作者 ID**: {{.Data.created_by.id}}
**作者姓名**: {{.Data.created_by.name}}
