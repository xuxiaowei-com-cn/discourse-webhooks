...
|--------------------------|--------------------------------------------------------------|---------|
| `--port` / `-p`          | HTTP 端口                                                    | `8080`  |
| `--secret` / `-s`        | HMAC-SHA256 签名密钥，为空代表不验证签名                     | 空      |
| `--skip-private-message` | 跳过 private_message（私信）类型的话题/帖子相关 Webhook 通知 | `false` |
...
| notification   | notification_created7                | ✅   | 通知创建             |
...
| notification   | notification_created27               | ✅   | 通知创建             |
| notification   | notification_created28               | ✅   | 通知创建             |
...
| user_promoted  | user_promoted                        | ✅   | 用户晋升             |
